...
import 'package:recreate/allConstants/app_constants.dart';
import 'package:recreate/allWidgets/loading_view.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void updateFirestoreData() {
    ...
    profileProvider.updateFirestoreData(
      ...
      Fluttertoast.showToast(msg: 'UpdateSuccess', backgroundColor: Colors.green);
    }).catchError((onError) {
      Fluttertoast.showToast(msg: onError.toString(), backgroundColor: Colors.orange);
    });
  }
